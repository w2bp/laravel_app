...
<html>
<head>
    <title>404 | @lang('web.texts.page_not_found')</title>
    <meta charset="utf-8">
    <style>
        body {
        ...
        .maincontainer {
            ...
            top: -50px;
            transform: scale(0.8);
            background: url("{{ asset('images/errors/background.png') }}");
...
<body>
    <div class="maincontainer">
        @for($i = 1; $i <= 3; $i++)
        <div class="bat">
            <img class="wing leftwing" src="{{ asset('images/errors/wing.png') }}">
            <img class="body" src="{{ asset('images/errors/body.png') }}" alt="bat">
            <img class="wing rightwing" src="{{ asset('images/errors/wing.png') }}">
        </div>
        @endfor
        <img class="foregroundimg" src="{{ asset('images/errors/house.png') }}" alt="house">
    </div>

    <h1 class="errorcode">404</h1>
    <div class="errortext">@lang('web.texts.page_not_found'). <a href="{{ \URL::previous() }}">@lang('web.texts.go_back')</a></div>
